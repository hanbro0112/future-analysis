...
from price_broadcaster import is_trading_hours
...
def test_is_trading_hours_true_during_day_session():
    ...
    dt = datetime(2026, 7, 27, 10, 30, tzinfo=TAIPEI_TZ)  # 2026-07-27 為週一
...
def test_is_trading_hours_true_during_night_session():
    ...
    dt = datetime(2026, 7, 27, 16, 30, tzinfo=TAIPEI_TZ)
...
def test_is_trading_hours_false_before_market_open():
    ...
    dt = datetime(2026, 7, 27, 7, 0, tzinfo=TAIPEI_TZ)
